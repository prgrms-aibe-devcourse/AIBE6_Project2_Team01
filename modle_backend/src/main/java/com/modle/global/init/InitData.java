...
public class InitData {
    ...
    public void work4() {
        ...
        modelService.update(model1, "홍길동", 180, 75, true, 25, "패션", "tag1", "안녕하세요, 홍길동입니다.",
        ...
        modelService.update(model2, "김철수", 175, 68, true, 30, "헤어", "tag2", "안녕하세요, 김철수입니다.",
        ...
        modelService.update(model3, "이영희", 165, 55, false, 28, "피트니스", "tag3", "안녕하세요, 이영희입니다.",
