    ...
    <div className="bg-white border-t-2 border-black pt-10 text-black">
      ...
      <div className="flex flex-col md:flex-row items-center md:items-start gap-8 mb-10">
        ...
        <div className="flex flex-col items-center md:items-start flex-grow">
          <h2 className="text-4xl text-black font-black mb-4 tracking-tighter uppercase">{data.name}</h2>
          ...
          {data.field && (
            <p className="text-xs font-bold uppercase tracking-widest text-black mt-2">
              <span className="text-gray-500 mr-2 border-r border-black pr-2">활동 분야 (CATEGORY)</span> {data.field}
            </p>
          )}
        </div>
      </div>
      ...
      <div className="mb-12">
        <h3 className="text-xl text-black font-black mb-6 uppercase tracking-widest border-b-2 border-black pb-3">소개글 (ABOUT ME)</h3>
      ...
      {/* 태그 영역 */}
      <div className="mb-8">
        <h3 className="text-xl text-black font-black mb-6 uppercase tracking-widest border-b-2 border-black pb-3">내 태그 (MY TAGS)</h3>
