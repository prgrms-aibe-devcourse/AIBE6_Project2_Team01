    ...
    <div className="flex flex-col md:flex-row items-center md:items-start gap-8 pb-8 mb-8 text-black">
      ...
      <div className="flex-grow flex flex-col items-center md:items-start">
        <div className="flex flex-col md:flex-row md:items-end gap-3 mb-3">
          ...
          <div className="flex items-center gap-1 ml-0 md:ml-4 bg-black text-white px-4 py-1.5 text-xs font-bold uppercase tracking-widest border border-black rounded-full shadow-sm">
        ...
        <div className="flex gap-3 w-full md:w-auto mt-4">
          <Link href="/my/profile/edit" className="flex-1 md:flex-none">
            <button className="w-full px-8 py-3 bg-black hover:bg-gray-900 text-white text-xs font-bold tracking-widest uppercase transition-colors border border-black rounded-full shadow-md hover:-translate-y-0.5">
              프로필 편집
            </button>
          </Link>
        </div>
